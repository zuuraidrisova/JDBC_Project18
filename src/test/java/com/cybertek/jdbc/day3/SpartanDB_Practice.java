...
//    8, Print out the data at row 5, column 1
        ...
        System.out.println("getEntireColumnDataAtRow(5,1) = " + getEntireColumnDataAtRow(5, 1));

//    9, Print out the data at row 53, phone column

        System.out.println("getEntireColumnDataAtRow(53, \"phone\") = " + getEntireColumnDataAtRow(53, "phone"));
